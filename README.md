...
Phase 2 of [`docs/http-based-sagas.md`](docs/http-based-sagas.md) (§5) — a different problem from the
...
[`docs/mixed-sagas.md`](docs/mixed-sagas.md) — a saga that drives a broker participant and a REST
