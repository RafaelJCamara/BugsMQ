...
only — no DSL/runtime), and additional transport adapters (MassTransit/Wolverine). Also out of
scope: parallel/fan-out saga steps, sub-saga composition, and broader test-coverage expansion (e.g.
SignalR hub/polling-service tests) beyond what's needed to verify the changes below.
