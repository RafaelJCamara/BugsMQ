...
public static class ServiceCollectionExtensions
{
    ...
    /// outbound/inbound middleware pipeline — mirrors <c>AddVSagaRabbitMq</c>'s shape exactly. Register
    ...
    /// </summary>
    public static IServiceCollection AddVSagaBrighter(this IServiceCollection services, Action<BrighterOptions>? configure = null)
    {
