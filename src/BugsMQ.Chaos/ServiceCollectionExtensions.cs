...
/// built; registration order relative to <c>AddBugsMqRabbitMq</c> doesn't matter, since the transport
...
public static class ServiceCollectionExtensions
{
    ...
    /// </summary>
    public static IServiceCollection AddBugsMqChaos(this IServiceCollection services, Action<ChaosOptions>? configure = null)
    {
