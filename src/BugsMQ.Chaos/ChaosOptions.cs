...
/// <summary>
/// Root config for BugsMQ.Chaos, bound the same way as RabbitMqOptions/SagaOrchestratorOptions — see
/// <see cref="ServiceCollectionExtensions.AddBugsMqChaos"/>. Each fault type is independently tuned
