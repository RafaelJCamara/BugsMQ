...
/// Wolverine's own Envelope-to-AMQP-properties mapping, so that BugsMQ's four well-known headers (and
/// everything else in <see cref="BugsMQ.Abstractions.Transport.MessageEnvelope.Headers"/>) round-trip
