...
public static class ServiceCollectionExtensions
{
    ...
    /// exercised for BugsMQ business messages — then wraps the resulting <see cref="IMessageTransport"/>
    ...
    /// </summary>
    public static IServiceCollection AddBugsMqWolverine(this IServiceCollection services, Action<WolverineTransportOptions>? configure = null)
    {
        ...
        {
            opts.ServiceName = "BugsMQ.Transport.Wolverine";
            ...
            // x-bugsmq-delivery-attempt header, and never relies on broker-native requeue. Wolverine's own
