...
/// <summary>
/// Marker message type that every single piece of BugsMQ traffic is carried as, as far as Wolverine's own
...
/// <summary>
/// The one and only Wolverine-discovered handler for BugsMQ traffic. Every message this transport sends
/// arrives here regardless of its real BugsMQ message type (see <see cref="RawEnvelope"/>) and is handed
...
/// reason as <see cref="RawEnvelope"/>; not part of BugsMQ's own public API surface.
/// </summary>
