...
/// <summary>
/// Bridges VSaga's explicit ack/nack contract onto Wolverine's own implicit ack-on-return/fault-on-throw
...
/// — every VSaga handler (SagaOrchestrator, the sample's ParticipantService) awaits its own
...
internal sealed class WolverineAckContext : IMessageAckContext
{
    ...
    /// incremented x-vsaga-delivery-attempt header itself, never relying on broker-native requeue).
