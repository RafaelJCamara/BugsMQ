...
public static class ServiceCollectionExtensions
{
    ...
    /// Intended for local development and as the foundation of BugsMQ.Testing — not for production use.
    /// </summary>
    public static IServiceCollection AddBugsMqInMemoryPersistence(this IServiceCollection services)
    {
