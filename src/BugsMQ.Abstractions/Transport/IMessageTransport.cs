...
/// <summary>
/// The only thing BugsMQ.Core depends on to move messages. Concrete adapters (RabbitMQ, in-memory,
/// and later MassTransit/Wolverine) implement this using their own publish/consume primitives —
/// BugsMQ never uses another bus's native saga/state-machine features, only its transport.
/// </summary>
