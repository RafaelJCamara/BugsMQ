...
/// which is exactly the structural gap docs/sub-saga-composition.md §3.4 attributes to option (a) — the
/// parent's own timeout on its waiting state is what has to cover that case, not this saga.
/// </para>
/// </summary>
